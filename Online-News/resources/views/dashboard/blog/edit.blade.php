...
<x-breadcum onlineNews="Blog Edit Page"></x-breadcum>

<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-3">Blog Update Table</h4>
                ...
                <form action="{{ route('blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input name="title" type="text" class="form-control @error('title')
                                is-invalid
                            @enderror" id="inputEmail3" placeholder="Title" value="{{ $blog->title }}">
                            @error('title')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input name="slug" type="text" class="form-control @error('slug')
                                is-invalid
                            @enderror"  placeholder="Slug" value="{{ $blog->slug }}">
                            @error('slug')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea id="shortNote" name="short_description" type="text" class="form-control @error('short_description')
                                is-invalid
                            @enderror" >{{ $blog->short_description }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea id="longNote" name="description" type="text" class="form-control @error('description')
                                is-invalid
                            @enderror" >{{ $blog->description }}</textarea>
                            @error('description')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <img style="width: 20%; height= 20%; margin-left: 50%;" id="OnlineNews" src="{{ asset('upload/blog') }}/{{ $blog->thumbnail }}" alt="">
                    </div>
                    <div class="row mb-2">
