             ...
             <div class="row">
                 <div class="col-lg-12">
                     <div class="section-heading-2-title">
                         <img src="{{ asset('upload/logo/logo-dark.png') }}" alt="">
                    ...
                    <div class="post-list post-list-style2">
                        ...
                        <div class="post-list-content" style="text-align: center">
                            ...
                            <ul class="entry-meta">
                                ...
                                <li class="post-date"> <span class="line"></span> {{ Carbon\Carbon::parse($blogs->created_at)->format('D M-d,Y') }} </li>
                            </ul>
                            <div class="post-exerpt">
                                <p>{!!$blogs->short_description!!}</p>
                            </div>
                            <div class="post-btn">
                                <a href="{{ route('frontend.blog.single', $blogs->slug) }}" class="btn-read-more">Continue Reading <i class="las la-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                 @empty
