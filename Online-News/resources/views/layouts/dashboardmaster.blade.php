...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | Online News</title>
    ...
    {{-- tinymc --}}
    <script src="https://cdn.tiny.cloud/1/gvutniiga0u1baa7e7gwd4le0jp15aespjrksn03oekp7zre/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
</head>
                ...
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a href="#menuManagement" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            ...
                            <span class="menu-text"> Management Role</span>
                        ...
                        <div class="collapse" id="menuManagement">
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                    <a class='menu-link' href={{ route(name: 'management.role.index') }}>
                                        <span class="menu-text">Assign Existing Role</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a class='menu-link' href={{ route(name: 'management.user.block') }}>
                                        <span class="menu-text">User Block Show</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="menu-item">
                        <a href="#menuCategory" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            <span class="menu-icon"><i class="bx bx-file"></i></span>
                            <span class="menu-text"> Category Page </span>
                            <span class="menu-arrow"></span>
                        </a>
